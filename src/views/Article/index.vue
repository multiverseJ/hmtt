<template>
  <div class="article-container">
    ...
    <div class="article-bottom" v-if="!isLoading && !!article.art_id">
      ...
      ></CollectArticle>
      <!-- <CollectArticle
      :is_collected="article.is_collected" @update:is_collected="article.is_collected=$event"
      ></CollectArticle> -->
    ...
    <van-popup position="bottom" v-model="isReplayShow" style="height: 100%"
      ><ReplayComment v-if="isReplayShow" :comment="comment" @close="isReplayShow=false"></ReplayComment
    ></van-popup>
  </div>
</template>
